...
#     model_path = model_path # r'./vgg19_binary_classification.pth'
...
#     # Image path
#     image_path = image_path # r"C:\Users\quinj\Documents\HackathonKF\chest_xray\chest_xray\val\NORMAL\NORMAL2-IM-1436-0001.jpeg"
...
#     # Generate GradCAM
#     gradcam = grad_cam(model, img_tensor, class_idx, target_layer='features.35')  # Replace with the correct layer
...
#     # Plot GradCAM
#     label = 'Normal' if class_idx == 0 else 'Pneumonia'
...
# Make sure to replace 'model_path' and 'image_path' with the actual paths to your model and image files
# main_vgg19('./vgg19_binary_classification.pth', r"C:\Users\quinj\Documents\HackathonKF\chest_xray\chest_xray\val\NORMAL\NORMAL2-IM-1436-0001.jpeg")
